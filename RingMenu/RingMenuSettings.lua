...
function RingMenuSettings_SetupSettingsFrame()
    local settingsFrameConfig = {
        ...
        rows = {
            { name = "AutoClose", text = "Cerrar al hacer click", widget = "checkbutton", updateFunc = RingMenuSettings_AutoClose_OnUpdate },
            { name = "NumButtons", text = "Numero de botones", widget = "slider", min = 1, max = 24, valueStep = 1, updateFunc = RingMenuSettings_NumButtons_OnUpdate },
            { name = "FirstButtonIndex", text = "Espacio para el primer botón", widget = "number", updateFunc = RingMenuSettings_FirstButtonIndex_OnUpdate },
            { name = "BackgroundColor", text = "Color de fondo", widget = "color", updateFunc = RingMenuSettings_BackgroundColor_OnUpdate },
            { name = "Radius", text = "Radio", widget = "slider", min = 0, max = 300, labelSuffix = " px", valueStep = 1, updateFunc = RingMenuSettings_Radius_OnUpdate },
            { name = "Angle", text = "Ángulo", widget = "slider", min = 0, max = 360, labelSuffix = "°", valueStep = 1, updateFunc = RingMenuSettings_Angle_OnUpdate },
        ...
        buttons = {
            { name = "Okay", text = "Guardar", func = RingMenuSettings_CloseOkay },
            { name = "Cancel", text = "Cancelar", func = RingMenuSettings_CloseCancel },
            { name = "Default", text = "Restablecer", func = RingMenuSettings_Reset },
        },
    }
