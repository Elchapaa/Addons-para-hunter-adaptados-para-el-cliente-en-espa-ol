...
if GetLocale() == "esES" then
	mangosta="Mordedura de mangosta"
	arcano="Disparo Arcano"
else
	mangosta="Mongoose Bite"
	arcano="Arcane Shot"
...
local function ScanActionBar()
	...
	for i=1, 120 do
		...
		if HPScanTipTextLeft1 and HPScanTipTextLeft1:GetText() == mangosta then
			RaptorStrikeSlot = i
		elseif HPScanTipTextLeft1 and HPScanTipTextLeft1:GetText() == arcano then
			ArcaneShotSlot = i
		end
	end
end
