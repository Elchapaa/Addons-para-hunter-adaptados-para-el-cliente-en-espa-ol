...
if (GetLocale() == "esES") then
	...
	-- If the player has a buff whose icon name contains "Ability_Mount" and whose name contains one of these substrings, we assume the player is mounted. We have to use this rather oblique way to check for mounted because some other buffs use the Ability_Mount_* icons. If these aren't localized, we may not recognize when the player is mounted and still try to feed the pet.
	FOM_MOUNT_NAME_SUBSTRINGS = { "kodo", "lobo", "raptor", "corcel", "caballo", "carnero", "sable", "mecazancudo" };

	-- No está claro si se supone que el quinto y sexto rendimiento de GetIteminfo () están localizados ... por lo que tenemos claves localizadas para ellos por si acaso.Si estos no están localizados, solo buscaremos comida innecesaria en sus mochilas de munición.
	FOM_AMMO_POUCH = "Faltriquera de munición";
	FOM_QUIVER = "Carcaj";
	...
	-- Used in tooltips to indicate food quality.
	FOM_QUALITY_UNKNOWN	= "%s podria comer esto, pero aún no lo has intentado.";
	FOM_QUALITY_UNDER	= "%s ya no le gusta esto.";
	FOM_QUALITY_MIGHT	= "%s podría comer esto.";
	FOM_QUALITY_WILL	= "%s comerá esto.";
	FOM_QUALITY_LIKE	= "%s le gusta comer esto.";
	FOM_QUALITY_LOVE	= "%s le encanta comer esto.";

	-- User-visible errors
	FOM_ERROR_NO_PET		= "No tienes una mascota para alimentar.";
	FOM_ERROR_PET_DEAD		= "Tu mascota está muerta.";
	FOM_ERROR_NO_FEEDABLE_PET	= "No tienes una mascota alimentable.";
	FOM_ERROR_IN_COMBAT	= "No puedes alimentar a tu mascota durante el combate.";
	FOM_ERROR_FOOD_NOT_FOUND	= "%s no pudo encontrar %s en tu mochila.";
	FOM_ERROR_NO_FOOD		= "%s No se pudo encontrar ningún alimento en su mochila.";
	FOM_ERROR_NO_FOOD_NO_FALLBACK	= "%s No se pudo encontrar ningún alimento en tu mochila que no le hayas prohibido comer a %s";

	FOM_PRONOUN_MALE 	= "el";
	FOM_PRONOUN_FEMALE	= "ella";

	-- Feeding status messages
	FOM_FEEDING_EAT_ANOTHER		= "%s no le gusta esa comida, prueba otra cosa...";
	FOM_FEEDING_FEED_ANOTHER	= "necesitas alimentar a  %s con otra cosa.";
	FOM_FEEDING_EAT			= "%s come un %s de tu mochila."; 
	FOM_FEEDING_FEED		= "alimenta a  %s con una %s. ";

	FOM_PET_HUNGRY		= "¡%s tiene hambre!";
	FOM_PET_VERY_HUNGRY	= "¡%s tiene mucha hambre!";

	-- Beast family names
	BAT = "Murciélago";
	BEAR = "Oso";
	BOAR = "Jabalí";
	CARRION_BIRD = "Carroñero";
	CAT = "Felino";
	CRAB = "Cangrejo";
	CROCOLISK = "Cocodrilo";
	GORILLA = "Gorila";
